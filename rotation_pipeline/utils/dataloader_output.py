...
def process_all_folders(base_input_path, output_base_path):
    ...
    # subfolders = [
    #     "output_indoor5_sculpture2", "output_indoor8_sculpture2", "output_indoor9_sculpture2", 
    #     "output_outdoor1_sculpture2", "output_outdoor5_sculpture2", "output_outdoor6_sculpture2", 
    #     "output_outdoor8_sculpture2", "output_outdoor9_sculpture2"
    # ]

    subfolders = [
        "output_indoor5_sculpture2",  "output_indoor9_sculpture2", 
        "output_outdoor3_sculpture2", "output_outdoor5_sculpture2", "output_outdoor6_sculpture2", 
        "output_outdoor8_sculpture2", "output_outdoor12_sculpture2", "output_outdoor16_sculpture2"
    ]
    ...
    for subfolder in subfolders:
        ...
        dataset_pairs_file = os.path.join(base_input_path, "sculpture2", subfolder, 'dataset_pairs.json')

        # 处理每个子文件夹中的数据对
        if os.path.exists(dataset_pairs_file):
            process_pairs(dataset_pairs_file, os.path.join(base_input_path, "sculpture2", subfolder), output_base_path)
        else:
